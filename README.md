...
2. 质押时间: 30天
3. 30天利率: 60%
4. 质押逻辑: 需记录每次的质押金额及质押时间(秒时间戳方式)
   - 【提前赎回的行为】=【总质押金额】—【赎回金额】
   - 【赎回金额扣除】= 优先扣除最早一笔的（即N），若赎回金额大于N，则从N+1扣除，以此类推（注: 如果赎回金额>总投入金额，则赎回失败）
   - 【剩余金额的计算逻辑】=N\*⌊质押时间/质押周期⌋\*利率 + N+1\*⌊质押时间/质押周期⌋\*利率......（以此类推）
...
5. 【邀请业务】裂变:
   - A用户邀请B用户奖励机制: 【A用户收取B用户所有质押总额2.5%】
   - 质押指定时间后合约收取5%管理费并给邀请者打2.5%邀请奖励，若时间不足收取管理费，没有2.5%的邀请奖励
